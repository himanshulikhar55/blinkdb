...
/**
 * @file diskstorage.h
 * @brief Provides the diskstorage class for disk-based storage of key-value pairs.
 *
...
/**
 * @brief This class is used to store key-value pairs on disk.
 * 
 */
class diskstorage {
private:
...
public:
    /**
     * @brief Construct a new diskstorage object. It opens the file "data.log" in current directory in append mode.
    ...
    /**
     * @brief Function to write a key-value pair to disk. It also updates the sparse index with the key and offset in the file.
     * 
    ...
    /**
     * @brief Function to read a key-value pair from disk using the key. It uses the sparse index to find the offset in the file.
     * 
     * @param key The key in the key-value pair
     * @param sparseIndex The sparse index that stores the key and offset in the file
